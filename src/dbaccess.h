...
check_result svdb_propertygetstr(svdb_connection* self, const char* propname, int lenpropname, bstring s);
check_result svdb_propertysetstr(svdb_connection* self, const char* propname, int lenpropname, const char* val);
check_result svdb_propertygetstrlist(svdb_connection* self, const char* propname, int lenpropname, bstrList* val);
check_result svdb_propertysetstrlist(svdb_connection* self, const char* propname, int lenpropname, const bstrList* val);
...
check_result svdb_filesinsert(svdb_connection* self, const bstring path, uint64_t collectionid, sv_filerowstatus status, uint64_t *outid);
...
check_result svdb_contentsbyhash(svdb_connection* self, const hash256* hash, uint64_t contentslength, svdb_contents_row* row);
